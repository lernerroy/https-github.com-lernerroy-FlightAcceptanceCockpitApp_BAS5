sap.ui.define([
	...
	return BaseController.extend("com.legstate.fts.app.FlightAcceptanceCockpit.av.controller.Detail", {
		...
		_createOverallStatusesPopover: function () {
			if (!this._oInteracesPopOver) {
				this._oInteracesPopOver = sap.ui.xmlfragment("com.legstate.fts.app.FlightAcceptanceCockpit.av.fragments.InterfacesStatus", this);
			}
