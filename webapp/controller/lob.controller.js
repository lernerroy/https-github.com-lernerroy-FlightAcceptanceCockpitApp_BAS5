sap.ui.define([
	...
	return BaseController.extend("com.legstate.fts.app.FlightAcceptanceCockpit.tp.controller.lob", {
		...
		_addAirportChargesContent: function(sObjectPath){
			...
			var oPassangerFragment = sap.ui.xmlfragment("com.legstate.fts.app.FlightAcceptanceCockpit.tp.fragments.PassangerDetails", oPassangerFragmentController);
