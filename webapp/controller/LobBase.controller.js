sap.ui.define([
	...
	"com/legstate/fts/app/FlightAcceptanceCockpit/tp/vendor/lodash.min",
	"../constants/Constants",
	"com/legstate/fts/app/FlightAcceptanceCockpit/tp/dialog/BusyDialogController",
	"sap/m/MessageBox",
	"sap/m/MessageToast"
], function (Controller, BaseController, JSONModel, lodash, Constants, BusyDialog, MessageBox, MessageToast) {
	"use strict";

	return BaseController.extend("com.legstate.fts.app.FlightAcceptanceCockpit.tp.controller.LobBase", {
		...
		onMoreServicesButtonPressed: function (oEvent) {
			if (!this._oMoreServicesDialog) {
				this._oMoreServicesDialog = sap.ui.xmlfragment("com.legstate.fts.app.FlightAcceptanceCockpit.tp.fragments.MoreServices", this);
			}
