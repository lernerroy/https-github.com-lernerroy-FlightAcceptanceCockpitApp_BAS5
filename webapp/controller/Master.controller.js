sap.ui.define([
	...
	return BaseController.extend("com.legstate.fts.app.FlightAcceptanceCockpit.tp.controller.Master", {
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!oDialog) {
				oDialog = sap.ui.xmlfragment(this.getView().getId(), "com.legstate.fts.app.FlightAcceptanceCockpit.tp.view.ViewSettingsDialog", this);
